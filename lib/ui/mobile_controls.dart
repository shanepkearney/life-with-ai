    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          button(Icons.shuffle_rounded, 'Randomise', () => c.randomize()),
          button(
          ...
          if (onSaveMoment != null) button(Icons.favorite_border_rounded, 'Save this moment to favourites', onSaveMoment),
