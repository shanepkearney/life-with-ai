...
The same frame, packed with random soup. The soup burns white-hot and eats through the walls,
...
| Hotspots: crowded regions run from cyan through magenta to amber | The Community tab |
|---|---|
...
the picture, and the board can be cropped out of the full window afterwards.
